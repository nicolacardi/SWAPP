<?	include_once("database/databaseii.php");
	...
	<select name="selectclasse"   id="selectclasse" onchange="PopolaSelectAlunno(); PopolaVerbali(); Popola_aselme_cla(); Popola_tipopagella();">
		<?
		...
		for ($x = 1; $x <= $i; $x++) {
				?>
				<option value="<?=$classiA[$x]?>" <?if ($x==0) {echo ('selected');}?>><?=$desc_clsA[$x]?></option><?
