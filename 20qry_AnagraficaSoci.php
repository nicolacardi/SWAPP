<?include_once("database/databaseii.php");
	...
	$sql = "SELECT DISTINCT ID_soc, nome_soc, cognome_soc, tipo_soc, dataiscrizione_soc FROM tab_anagraficasoci ".$whereannocorrente.$ordsql;
	...
	$riga++;	?>
		<tr>
            ...
            <td>
				<input class="tablecell6 disab val<?=$ID_soc?> w150px" type="text" id="dataiscrizione_soc<?=$ID_soc?>" name="dataiscrizione_soc" value = "<?=$dataiscrizione_soc?>" disabled>
			</td>
		</tr>
	<?}?>
<script>
