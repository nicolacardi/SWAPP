...
$pdf->Cell(0,6,utf8_decode("I PRINCIPI PEDAGOGICI DELLA PEDAGOGIA STEINERIANA"), 0,1, 'C');
$fontsizedefault = 9;
...
<n>
E' infatti una loro peculiarità che i processi decisionali siano di natura collegiale: il Collegio degli insegnanti si occupa non solo delle necessità di natura didattica e dell'orientamento pedagogico, ma anche di scelte pratiche importanti e delicate come la selezione (nuove figure ed eventuali allontanamenti) del corpo docenti. 
</n>
<n>
Il Collegio -come già evidenziato- è il centro culturale/spirituale della scuola. Si incontra ogni settimana ed è formato da tutti gli insegnanti in carica e dal medico scolastico. Elenchiamo, per concludere, alcune delle attività che ne caratterizzano il lavoro, che è, di fatto, il cuore pulsante della nostra offerta formativa:
</n>
<bul>
durante le riunioni viene svolto uno studio comune su temi antropologici e pedagogici, realizzando così quella che viene chiamata ''formazione continua'' degli insegnanti;
</bul>
<bul>
ci sono delle ''parti pedagogiche'' durante le quali i singoli insegnanti condividono coi colleghi le attività che propongono alle classi, per una percezione comune di tali attività e per l'arricchimento di ogni insegnante;
</bul>
<bul>
ci sono anche delle parti artistiche, proposte dai diversi insegnanti, sempre al fine di una condivisione delle attività pedagogiche e/o della ''formazione continua degli insegnanti'';
</bul>
<bul>
integrando il lavoro dei singoli consigli di classe, sono previsti nel corso dell'anno dei momenti durante i quali l'intero Collegio si focalizza sui singoli allievi o sull'andamento delle classi;
</bul>
<bul>
a fine anno scolastico e prima della ripresa del seguente, viene effettuato un lavoro di retrospettiva/prospettiva e di autovalutazione del lavoro di Collegio, dei consigli di classe e dei singoli insegnanti.
</bul>
";
