<?
    ...
    if ($codscuola =='PD') {
        ...
        <bul>dell'importanza di avvicinarsi alla conoscenza e alla comprensione dei principi che sono alla base del pensiero di R. Steiner relativamente all'essere umano nella sua triplice attività di Pensare Sentire e Volere come fondamento della struttura della Scuola Waldorf, in modo tale che all'interno della Scuola intesa come organismo, ciascuno possa trovare il proprio ruolo nella chiarezza e nel rispetto dei compiti che Steiner riconosce al Collegio degli Insegnanti, al Consiglio di Amministrazione e ai Genitori, per una sana e corretta partecipazione alla vita della comunità scolastica. (v. Allegato A, da conservare)</bul>
        <bul>dell'importanza di partecipare alle conferenze e alle attivita' che la Scuola ogni anno propone al fine di comprendere i principi che regolano il percorso pedagogico.</bul>
        ...
        <bul>Organizzare e gestire le attività in un clima di dialogo e collaborazione che consenta al collegio e alle famiglie di poter lavorare al meglio alla realizzazione degli obiettivi educativi e culturali del PTOF;</bul>
        ...
        <bul>Partecipare in clima di collaborazione costruttiva al Progetto educativo e didattico, nel rispetto delle valutazioni pedagogiche attuate dal Collegio degli Insegnanti riguardanti sia l'idoneità alla scolarizzazione (valutazione della maturità scolare dell'alunno/a per l'ingresso nelle classi) sia l'accoglienza di allievi
        provenienti da scuole esterne.</bul>
        ...
        <bul>Sostenere la cultura del dialogo ed educare alla cittadinanza attiva prevenendo e contrastando attegiamenti antisociali;</bul>
        ...
        <bul>Approfondire i contenuti del PTOF, le iniziative extracurricolari e i progetti della Scuola;</bul>
        ...
        Il presente patto di corresponsabilità, elaborato dal Collegio docenti, viene sottoscritto dal Coordinatore didattico e dal Presidente dell'ente gestore e ha validità per tutto il percorso, salvo successive modifiche da concordare tra le parti.<br>
