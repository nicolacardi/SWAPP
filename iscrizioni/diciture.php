...
switch ($codscuola) {
    ...
    case 'PD':
        ...
        $titolaretrattamentoTitolo = "la Steiner-Waldorf Padova Soc. Coop. Sociale";
    ...
    case 'CI':
        ...
        $linkPTOF = "https://www.aurorascuola.it/aurora/wp-content/uploads/2023/02/PTOF-2022-25-definitivo.pdf";
        $scadpagamenti ="entro il giorno 5 di ciascun mese";
        $quotaiscrizione = "100 per ciascun/a alunno/a iscritto/a";
        $scadrientromodulo = "31/01/";
        $scadrientromodulolett = "31 gennaio ";
        $scadiscrizione = "07/02/";
        $scadiscrizionelett = "7 febbraio ";
