<?
        ...
        $pdf->Cell(0,8,"RICHIESTA SERVIZIO DOPOSCUOLA a.s. ".$annoscolastico, 0,1, 'C');
        ...
        $testo = "CHIEDONO PER ".$LUILEI[$mf_alu]." DI USUFRUIRE DEL SERVIZIO DOPOSCUOLA PER I SEGUENTI GIORNI";
		...
		$pdf->Cell(190,$h1,utf8_decode($testo),0,1,'L');
        $testo = "- la quota del doposcuola è annuale e verrà addebitata tramite SDD (o bonifico per chi non l'avesse
        attivato) in nove rate il 5 del mese (da ottobre a giugno) ed è sempre dovuta per intero anche in
        caso di assenze per festività, chiusure scuola, malattia, altri motivi familiari, ecc....;";
        $pdf->MultiCell(0,5,utf8_decode($testo));
		
        $testo = "- causale da indicare nel bonifico: cognome e nome del bambino - doposcuola;";
		$pdf->Cell(190,$h1,utf8_decode($testo),0,1,'L');
        $testo = "- banca d'appoggio: BCC Credito Padano IBAN IT14O0845459960000000115149.";
		$pdf->Cell(190,$h1,utf8_decode($testo),0,1,'L');
