...
$testo= "Se il bambino presenta allergie ed intolleranze alimentari, che necessitano di una dieta particolare, dovrà essere tempestivamente presentata la certificazione del medico di fiducia con le specifiche indicazioni.";
$pdf->SetFont($fontdefault,'',10);
$testo = utf8_decode($testo);
$pdf->MultiCell(0,5,$testo);
...
Nel caso di alunni con patologie particolari, possono essere somministrati solamente farmaci indispensabili, su prescrizione del pediatra curante, con l'indicazione della posologia, della modalità di somministrazione e della corretta conservazione del farmaco e con delega del genitore (vedi modulo Delega alla somministrazione di farmaci, in segreteria).
";
$pdf->SetFont($fontdefault,'',10);
$testo = utf8_decode($testo);
$pdf->MultiCell(0,5,$testo);
...
$testo= "I genitori non devono portare il bambino a scuola quando presenta sintomi di malattia acuta in atto: febbre, vomito, diarrea, manifestazioni cutanee contagiose, congiuntiviti, bambino affaticato, pianto persistente, tosse continua, dolore addominale persistente.
