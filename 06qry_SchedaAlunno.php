...
<!-- ESTRAZIONE DATI ******************************************************************************************-->
		<?
		$sql2 = "SELECT DISTINCT ID_alu, nome_alu, cognome_alu, mf_alu, datanascita_alu, comunenascita_alu, provnascita_alu, paesenascita_alu, cittadinanza_alu, cf_alu, indirizzo_alu, citta_alu, prov_alu, paese_alu, CAP_alu, autfoto_alu, scuolaprimaprovenienza_alu, indirizzoscprimaproven_alu, scuolaprovenienza_alu, indirizzoscproven_alu, ckautfoto_alu, ckautmateriale_alu, ckautuscite_alu, ckautuscitaautonoma_alu, ckmensa_alu, ckreligione_alu, altreligione_alu, cktrasportopubblico_alu, ckdoposcuola_alu, note_alu, img_alu, disabilita_alu, dettaglidisabilita_alu, DSA_alu, ".//campi di tab_anagraficaalunni
		"nomemadre_fam, cognomemadre_fam, nomepadre_fam, cognomepadre_fam, telefonomadre_fam, altrotelmadre_fam, telefonopadre_fam, altrotelpadre_fam, emailmadre_fam, emailpadre_fam, sociomadre_fam, sociopadre_fam,  ".
		"datanascitapadre_fam, comunenascitapadre_fam, provnascitapadre_fam, paesenascitapadre_fam, cittadinanzapadre_fam, cfpadre_fam, indirizzopadre_fam, comunepadre_fam, CAPpadre_fam, provpadre_fam, paesepadre_fam, profpadre_fam, titolopadre_fam, ".
		"datanascitamadre_fam, comunenascitamadre_fam, provnascitamadre_fam, paesenascitamadre_fam, cittadinanzamadre_fam, cfmadre_fam, indirizzomadre_fam, comunemadre_fam, CAPmadre_fam, provmadre_fam, paesemadre_fam, profmadre_fam, titolomadre_fam, imgmadre_fam, imgpadre_fam, notemadre_fam, notepadre_fam, intestazionefatt_fam, ID_fam_alu, ibanpadre_fam, ibanmadre_fam, rapprpadre_fam, rapprmadre_fam, ruolopadre_fam, ruolomadre_fam ".
		...
		mysqli_stmt_bind_result($stmt2, $ID_alu_det, $nome_alu_det, $cognome_alu_det, $mf_alu_det, $datanascita_alu_det, $comunenascita_alu_det, $provnascita_alu_det, $paesenascita_alu_det, $cittadinanza_alu_det, $cf_alu_det, $indirizzo_alu_det, $citta_alu_det, $prov_alu_det, $paese_alu_det, $CAP_alu_det, $autfoto_alu_det, $scuolaprimaprovenienza_alu_det, $indirizzoscprimaproven_alu_det, $scuolaprovenienza_alu_det, $indirizzoscproven_alu_det, $ckautfoto_alu_det, $ckautmateriale_alu_det, $ckautuscite_alu_det, $ckautuscitaautonoma_alu_det, $ckmensa_alu_det, $ckreligione_alu_det, $altreligione_alu_det, $cktrasportopubblico_alu_det, $ckdoposcuola_alu_det, $note_alu, $img_alu, $disabilita_alu_det, $dettaglidisabilita_alu_det, $DSA_alu_det, $nomemadre_fam_det, $cognomemadre_fam_det, $nomepadre_fam_det, $cognomepadre_fam_det, $telefonomadre_fam_det, $altrotelmadre_fam_det, $telefonopadre_fam_det, $altrotelpadre_fam_det, $emailmadre_fam_det, $emailpadre_fam_det, $sociomadre_fam_det, $sociopadre_fam_det, $datanascitapadre_fam_det, $comunenascitapadre_fam_det, $provnascitapadre_fam_det, $paesenascitapadre_fam_det, $cittadinanzapadre_fam_det, $cfpadre_fam_det, $indirizzopadre_fam_det, $comunepadre_fam_det, $CAPpadre_fam_det, $provpadre_fam_det, $paesepadre_fam_det, $profpadre_fam_det, $titolopadre_fam_det, $datanascitamadre_fam_det, $comunenascitamadre_fam_det, $provnascitamadre_fam_det, $paesenascitamadre_fam_det, $cittadinanzamadre_fam_det, $cfmadre_fam_det, $indirizzomadre_fam_det, $comunemadre_fam_det, $CAPmadre_fam_det, $provmadre_fam_det, $paesemadre_fam_det, $profmadre_fam_det, $titolomadre_fam_det, $imgmadre_fam, $imgpadre_fam, $notemadre_fam, $notepadre_fam, $intestazionefatt_fam, $ID_fam_alu, $ibanpadre_fam, $ibanmadre_fam, $rapprpadre_fam, $rapprmadre_fam, $ruolopadre_fam, $ruolomadre_fam);
...
<script>
	...
	function aggiornaAnagrafica (pagina) {
		...
		let cittadinanzapadre_fam = $('#cittadinanzapadre_fam_det').val();
		...
		let cittadinanzamadre_fam = $('#cittadinanzamadre_fam_det').val();
		...
		let ruolopadre_fam =  $('#ruolopadre_fam option:selected').val();
		let ruolomadre_fam =  $('#ruolomadre_fam option:selected').val();
