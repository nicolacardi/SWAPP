...
{
  return str.replace(/[^BCDFGHJKLMNPQRSTVWXYZ]/gi,''); // quando ^ si trova dentro [ NEGA: quindi tutto ciò che NON E' una consonante sostituiscilo con.../gi serve per sostituire TUTTE LE OCCORRENZE e CASE INSENSITIVE
};

CFisc.ottieni_vocali=function(str)
{
  return str.replace(/[^AEIOU]/gi,''); //come per le consonanti: sostituisce tutto ciò che NON E' (infatti c'è [^...]) una lettera, fallo per tutte le occorrenze (g) e fallo case insensitive (i)
};
...
//  //codice è come la i di for i = 0....
//	console.log("ciao"+this.codici_catastali['G224']);
//
//  console.log (re);
...
{ //questa è la funzione che smista alle varie altre i pezzi da calcolare
